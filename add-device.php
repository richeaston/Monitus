  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1><small>Add New Asset</small></h1>
            <ol class="breadcrumb">
              <li><a href="index.php"><img src="images/monitor.png"> Dashboard</a></li>
				<li><a href="assets.php"><img src="images/computer.png"> Assets</a></li>
			  <li class="active"><img src="images/computer_add.png"> Add New Asset</li>
            </ol>
          </div>
        <!-- end of breadcrumbs -->
		...
		<form class="" action="write-device.php" method="post">
            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><img src="images/computer_add.png"> New Asset Details</h3>
              </div>
              ...
              <div class="form-group input-group">
                ...
                <span class="input-group-addon"><img src="images/computer_add.png"> Name</span>
